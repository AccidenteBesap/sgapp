...
// Basic Column Chart Accidente
var chartColumnAccidenteColors = getChartColorsArray("column_chart_accidente");
if (chartColumnAccidenteColors) {
    var options = {
        chart: {
            height: 350,
            type: 'bar',
        ...
        series: [{
            name: 'Accidente CTP',
            data: [2, 4, 3, 5, 1, 3, 2, 1, 3, 4, 1, 2]
        }, {
            name: 'Accidente STP',
            data: [7, 9, 8, 6, 10, 5, 12, 7, 4, 11, 8, 9]
        }, {
            name: 'Cuasi Accidente',
            data: [5, 7, 2, 3, 8, 10, 9, 4, 1, 11, 2, 6]
        }, {
            name: 'Accidente Grave',
            data: [1, 2, 1, 0, 3, 1, 2, 5, 1, 0, 1, 1]
        }, {
            name: 'Accidente Fatal',
            data: [0, 0, 1, 0, 0, 0, 0, 0, 2, 0, 0, 0]
        }],
        colors: chartColumnAccidenteColors,
        xaxis: {
    ...
    var chart = new ApexCharts(
        document.querySelector("#column_chart_accidente"),
        options
    );
