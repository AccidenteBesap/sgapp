...
//Warning Message Metodologias
if (document.getElementById("sa-warning-medidas-grabar"))
    document.getElementById("sa-warning-medidas-grabar").addEventListener("click", function () {
        Swal.fire({
            title: "Esta seguro?",
            text: "Despues de grabar no podra modificar la informacion",
            icon: "warning",
            showCancelButton: true,
            confirmButtonClass: 'btn btn-primary w-xs me-2 mt-2',
            cancelButtonClass: 'btn btn-danger w-xs mt-2',
            ...
            if (result.value) {
                Swal.fire({
                    title: 'Grabado',
                    text: 'La informacion ha sido grabada',
                    icon: 'success',
                    confirmButtonClass: 'btn btn-primary w-xs mt-2',
                    buttonsStyling: false
                })
